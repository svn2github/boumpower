...
// Copyright (c) 2001-2005 TM-CAD Engineering Torsten Moses
//
// This file defines additional Support pathes for AutoCAD LT,
// and is used by LTSetup.exe / LTUninst.exe; Remove this file, 
// if the application does not need support pathes
//
// SYNTAX :
// --------------
...
ADDPATH  # ..\
ADDPATH  # ..\Bin
//SETMENU # .\BpsAcad-LT.mnu BpsAcad Pop1  SHOW
